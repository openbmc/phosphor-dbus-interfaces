...
object path, with the IP address and prefix length encoded using sdbusplus path
escaping.

Example IPv4: `/xyz/openbmc_project/network/eth0/_3192_2e168_2e1_2e1_2f24` (for
