...
There are three primary states to track and control on a BMC based server. The states
...
The _Drive_ interface provides per-drive transition requests (`Reboot`,
`HardReboot`, `Powercycle`) and state reporting (`CurrentDriveState`). Drive
