...
In addition, the `xyz.openbmc_project.Software.MinimumVersion` interface can be
used to communicate the minimum software version that a component must have to
operate. The minimum version check is an optional software feature of the item
updater.
