...
- Certificate class implements xyz.opebmc_project.Certs.Certificate
  interface which specify the properties of the certificate.
- Certificate class implements xyz.openbmc_project.Certs.Install to
  cater for replacing existing certificate.
