...
7. *Staged* - The `Software.Version` is in staged flash region. This will be moved
              from staged flash region to active flash region upon reset.
              ...
              firmware update process. Note that staged image is not necessarily
              a functional firmware.
