...
$domainvar += custom_target(
  ...
  input: '../$(basename "$file")',
  capture: true,
  command: [sdbusplusplus_prog, '-r', dbus_root, 'interface', 'server-cpp', '$fulldomain'])
...
$domainvar += custom_target(
  ...
  input: '../$(basename "$file")',
  capture: true,
  command: [sdbusplusplus_prog, '-r', dbus_root, 'interface', 'server-header', '$fulldomain'],
  install: true,
...
$mdvar += custom_target(
  ...
  input: '../$(basename "$file")',
  capture: true,
  command: [sdbusplusplus_prog, '-r', dbus_root, 'interface', 'markdown', '$fulldomain'])
...
$domainvar += custom_target(
  ...
  input: '../$(basename "$file")',
  capture: true,
  command: [sdbusplusplus_prog, '-r', dbus_root, 'error', 'exception-cpp', '$fulldomain'])
...
$domainvar += custom_target(
  ...
  input: '../$(basename "$file")',
  capture: true,
  command: [sdbusplusplus_prog, '-r', dbus_root, 'error', 'exception-header', '$fulldomain'],
  install: true,
  install_dir: get_option('includedir') / '$path')
...
$mdvar += custom_target(
  ...
  input: '../$(basename "$file")',
  capture: true,
  command: [sdbusplusplus_prog, '-r', dbus_root, 'error', 'markdown', '$fulldomain'])
EOF
    gen_domain["$domain"]=1
    gen_md["$path"]=1
  fi
